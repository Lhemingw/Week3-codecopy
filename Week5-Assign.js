...
// class StarTrek {  //I had NExtGen here- see if StarTrek will work as players
...
//     constructor() {
//         this.name = [];
//         //I had this.rank; here I do not need it for "team"
//     }
...
//         if (name instanceof StarTrek) {  //I had 
//             this.name.push(name);
//         } else {
//             throw newError (`you can only add an instance of argument is not a names a name: ${name}`);
//         }
//     }  

//         //Does what the top describe does
//         describe(){
//             return `Enterprise has ${this.name.length} members.`;
//         }
//     }
...
//                     break;
//                 case "2":
//                     this.viewEnterprise(); //I had viewNextGen here, I think Enterprise needs to go here, 
...
//              1. Create New Star Trek Character\n  
//              2. View all Star Trek Character\n
//              3. Red Shirt a Star Trek Character\n
//              4. Create Enterprise Team member\n
//              0. Exit\n  
//             `);
//         }

//             //Had NextGen- changed to Star Trek
...
//             const starTrek = new StarTrek(name, rank);
//             this.enterprise.addName(starTrek);
//             console.log(`Star Trek character ${name} created successfully!\n`);
//     }
...
//                 switch (selection ){
//                     case 1:
//                     this.createStarTrekMenu();//or is this Enterprise
//                     break;
//                     case 2:
//                     this.redShirtStarTrekMenu();
